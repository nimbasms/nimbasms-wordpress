...
- **2FA par SMS** — code à usage unique exigé à la connexion des administrateurs (expiration 10 min, anti-bruteforce, numéro par utilisateur dans le profil, constante d'urgence `NIMBASMS_DISABLE_2FA`)
